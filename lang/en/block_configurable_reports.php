...
$string['converttime'] = 'Convert timestamps?';
$string['converttimedescription'] = 'Do you want to convert timestamps to the viewer\'s timezone?';
$string['converttime_help'] = 'This will convert columns containing \'time\' to the user\'s timezone during report execution.';
...
$string['noresultdisplay'] = 'No results message';
$string['noresultdisplay_help'] = 'The message that is displayed when no results are found.';
$string['runable'] = 'Run';
$string['scheduleoptions'] = 'Schedule options';
$string['timeformat'] = 'Time format';
$string['timeformat_help'] = 'The strftime string that should be used when formatting timestamps.';
